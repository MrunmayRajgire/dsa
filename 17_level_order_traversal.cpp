// Initially a queue is required , that contains root of the tree

/* remove 1, check left, if it exists , push in queue. same for right
pop 1 from queue. put it in a vector
*/
